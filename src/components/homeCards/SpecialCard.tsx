  ...
  return (
    <div className='my-20'>
      <div className='w-[61.5%] mx-auto'>
        ...
        <h2 className='text-black/80 dark:text-white/90 text-center font-bold text-6xl mt-8'>
          Tailwind + Framer + React
        </h2>
        <h5 className='text-black/80 dark:text-white/70 text-center font-bold text-3xl mb-8'>
