...
const TemplateCard = () => {
    ...
    return (
        <div>
            <div className='w-[61.5%] p-2 my-20 rounded-3xl shadow bg-white dark:bg-neutral-900 mx-auto'>
                <div className='h-full p-6 bg-[#f4f4f4] dark:bg-neutral-800 shadow rounded-3xl mx-auto'>
                    <BadgeButton>Template</BadgeButton>
                    <div className='flex justify-between items-center'>
                        {cards.map((card, index) => (
                            <MinimalCard
                              className="m-2 w-[460px] text-black dark:text-white"
                              key={index}
                            >
                                <MinimalCardImage
                                    className="h-[160px]"
