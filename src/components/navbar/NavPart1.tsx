  ...
  return (
    <div className='flex items-center gap-4 text-foreground'>
      <a href="https://skiper-ui.com/" className='flex items-center gap-2'>
        ...
        <p className='text-[10px] border border-orange-600 rounded-full px-1.5 text-orange-600'>
          Beta
        </p>
      </a>
      <a href="#" className='text-muted-foreground text-sm'>Components</a>
      <a href="#" className='text-muted-foreground text-sm'>Pricing</a>
      <a href="#" className='text-muted-foreground text-sm'>Newsletter</a>
    </div>
  )
}
